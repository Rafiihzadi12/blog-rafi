...
<head>
    ...
    <!-- Page Title -->
    <title>Blog Rafi</title>

    <!-- Favicon icon -->
    <link rel="shortcut icon" type="image/png" href="{{url ('backend/images/favicon.png')}}">

    <!-- All StyleSheet -->
    <link href="{{url ('backend/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}" rel="stylesheet">
    <link href="{{url ('backend/vendor/owl-carousel/owl.carousel.css')}}" rel="stylesheet">
...
***********************************-->
    ...
    <!-- Dashboard 1 -->
    <script src="{{url ('backendjs/dashboard/dashboard-1.js')}}"></script>
